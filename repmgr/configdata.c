...
struct ConfigFileSetting config_file_settings[] =
{
	...
	/* ux_bindir */
	{
		"ux_bindir",
		CONFIG_STRING,
		{ .strptr = config_file_options.ux_bindir },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.ux_bindir) },
		{ .postprocess_func = &repmgr_canonicalize_path }
	},
	/* repmgr_bindir */
	{
	...
	/* repmgr_log_filename */
	{
		"repmgr_log_filename",
		CONFIG_STRING,
		{ .strptr = config_file_options.repmgr_log_filename },
		{ .strdefault = LOG_FILENAME_DEFAULT },
		{},
		{ .strmaxlen = sizeof(config_file_options.repmgr_log_filename) },
		{ .postprocess_func = &repmgr_canonicalize_path }
	},
	/* repmgr_log_directory */
	{
		"repmgr_log_directory",
		CONFIG_STRING,
		{ .strptr = config_file_options.repmgr_log_directory },
		{ .strdefault = LOG_DIRECTORY_DEFAULT },
		{},
		{ .strmaxlen = sizeof(config_file_options.repmgr_log_directory) },
		{ .postprocess_func = &repmgr_canonicalize_path }
	},
	/* repmgr_log_rotation_size */
	{
		"repmgr_log_rotation_size",
		CONFIG_INT,
		{ .intptr = &config_file_options.repmgr_log_rotation_size },
		{ .intdefault = LOG_ROTATION_SIZE_DEFAULT },
		{},
		{},
		{ .process_func_p = &parse_size }
	},
	/* repmgr_log_rotation_age */
	{
		"repmgr_log_rotation_age",
		CONFIG_INT,
		{ .intptr = &config_file_options.repmgr_log_rotation_age },
		{ .intdefault = LOG_ROTATION_AGE_DEFAULT },
		{},
		{},
		{ .process_func_p = &parse_time_interval }
	},
	/* ======================
	...
	/* ux_basebackup_options */
	{
		"ux_basebackup_options",
		CONFIG_STRING,
		{ .strptr = config_file_options.ux_basebackup_options },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.ux_basebackup_options) },
		{}
	},
	/* restore_command */
	{
	...
	/* ux_backupapi_backup_id*/
	{
		"ux_backupapi_backup_id",
		CONFIG_STRING,
		{ .strptr = config_file_options.ux_backupapi_backup_id },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.ux_backupapi_backup_id) },
		{}
	},
	/* ux_backupapi_host*/
	{
		"ux_backupapi_host",
		CONFIG_STRING,
		{ .strptr = config_file_options.ux_backupapi_host },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.ux_backupapi_host) },
		{}
	},
	/* ux_backupapi_node_name */
	{
		"ux_backupapi_node_name",
		CONFIG_STRING,
		{ .strptr = config_file_options.ux_backupapi_node_name },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.ux_backupapi_node_name) },
		{}
	},
	/* ux_backupapi_remote_ssh_command */
	{
		"ux_backupapi_remote_ssh_command",
		CONFIG_STRING,
		{ .strptr = config_file_options.ux_backupapi_remote_ssh_command },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.ux_backupapi_remote_ssh_command) },
		{}
	},
	...
	/* ux_ctl_options */
	{
		"ux_ctl_options",
		CONFIG_STRING,
		{ .strptr = config_file_options.ux_ctl_options },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.ux_ctl_options) },
		{}
	},
	...
	/* uxdb: virtual ip settings */
	{
		"virtual_ip",
		CONFIG_STRING,
		{ .strptr = config_file_options.virtual_ip },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.virtual_ip) },
		{}
	},
	{
		"network_card",
		CONFIG_STRING,
		{ .strptr = config_file_options.network_card },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.network_card) },
		{}
	},
	{
		"arping_command",
		CONFIG_STRING,
		{ .strptr = config_file_options.arping_command },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.arping_command) },
		{}
	},
	/* uxdb: disk checking settings */
	{
		...
		CONFIG_INT,
		{ .intptr = &config_file_options.device_check_timeout },
		{ .intdefault = DEVICE_CHECK_TIMEOUT },
		{ .intminval = 0 },
		{},
		{}
	},
	{
		"device_check_times",
		CONFIG_INT,
		{ .intptr = &config_file_options.device_check_times },
		{ .intdefault = DEVICE_CHECK_TIMES },
		{ .intminval = 0 },
		{},
		{}
	},
	/* uxdb: standby wait timeout */
	{
		...
		CONFIG_INT,
		{ .intptr = &config_file_options.standby_wait_timeout },
		{ .intdefault = DEFAULT_STANDBY_WAIT_TIMEOUT },
		{ .intminval = 0 },
		{},
		{}
	},
	/* uxdb: timely check brain split */
	{
		"check_brain_split",
		CONFIG_BOOL,
		{ .boolptr = &config_file_options.check_brain_split },
		{ .booldefault = false },
		{},
		{},
		{}
	...
	/* sync <-> async: try synchronous connection timeout. see check_sync_async */
	{
		...
		CONFIG_INT,
		{ .intptr = &config_file_options.try_synchronous_connection_timeout },
		{ .intdefault = DEFAULT_TRY_SYNCHRONOUS_CONNECTION_TIMEOUT },
		{ .intminval = 0 },
		{},
		{}
	},
	{
		"wal_encparms_path",
		CONFIG_STRING,
		{ .strptr = config_file_options.wal_encparms_path },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.wal_encparms_path) },
		{}
	},
	{
		"root_password",
		CONFIG_STRING,
		{ .strptr = config_file_options.root_password },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.root_password) },
		{}
	},
	{
		"uxdb_password",
		CONFIG_STRING,
		{ .strptr = config_file_options.uxdb_password },
		{ .strdefault = "" },
		{},
		{ .strmaxlen = sizeof(config_file_options.uxdb_password) },
		{}
	},
	/* ==================================
