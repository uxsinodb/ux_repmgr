...
extern bool do_standby_follow_internal(UXconn *primary_conn, UXconn *follow_target_conn, t_node_info *follow_target_node_record, UXSQLExpBufferData *output, int general_error_code, int *error_code);

void check_ux_backupapi_standby_clone_options(void);
