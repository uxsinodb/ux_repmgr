...
__attribute__((format(UX_PRINTF_ATTRIBUTE, 2, 3)));
...
__attribute__((format(UX_PRINTF_ATTRIBUTE, 4, 5)));
...
extern char *escape_string(UXconn *conn, const char *string);

extern void escape_double_quotes(char *string, UXSQLExpBufferData *out);

extern void
append_where_clause(UXSQLExpBufferData *where_clause, const char *clause,...)
__attribute__((format(UX_PRINTF_ATTRIBUTE, 2, 3)));
